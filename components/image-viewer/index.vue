<template>
  <div class="n22-image-viewer" v-show="isViewerShow" @click="$_viewerClick">
    <div class="viewer-container">
      <div class="one-img">
        <img v-if="isViewerShow&&imgs.length===1&&!!imgs[0].url" :src="imgs[0].url" :alt="imgs[0].alt" />
      </div>
      <swiper
        ref="swiper"
        :autoplay = "0"
        ...
        v-if="isViewerShow&&list.length!==1">
