...
export default {
  ...
  computed: {
    ...
    dealDefaultDate() {
      let date = this.selectValue ? (isNaN(new Date(this.selectValue).getTime())?this.defaultDate:this.selectValue) : this.defaultDate;
  ...
  methods: {
    ...
    onPickerConfirm(index, value) {
      console.log(
        "%c this.$refs[`picker${index}`].getColumnValues()",
        "color:green;",
        this.$refs[`picker${index}`].getColumnValues()
      );
      ...
      if (!this.isAppendTo) {
        ...
        this.btns.onPickerConfirm.handler.call(
          this,
          index,
          this.$refs[`picker${index}`].getColumnValues()
        );
    ...
    onDatePickerChange(columnIndex, itemIndex, value) {
      if (!this.isAppendTo) {
        ...
        this.btns.onDatePickerChange.handler.call(
          this,
          columnIndex,
          itemIndex,
          value
