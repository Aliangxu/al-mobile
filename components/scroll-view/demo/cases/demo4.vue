<template>
  <div class="n22-example-child n22-example-child-scroll-view n22-example-child-scroll-view-4">
    <n22-scroll-view
      ref="scrollView"
      :scrolling-x="false"
      @scroll="$_onScroll"
...
<script>import {ScrollView} from 'al-mobile'
...
<style lang="stylus">
.n22-example-child-scroll-view-4
  position relative
  height 800px
  background #FFF
