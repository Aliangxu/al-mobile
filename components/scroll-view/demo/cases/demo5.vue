<template>
  <div class="n22-example-child n22-example-child-scroll-view n22-example-child-scroll-view-5">
    <n22-tab-bar
...
<script>import {ScrollView, TabBar} from 'al-mobile'
...
<style lang="stylus">
.n22-example-child-scroll-view-5
  position relative
  height 800px
  background #FFF
  .n22-tab-bar
