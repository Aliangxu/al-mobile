<template>
  <div class="n22-example-child n22-example-child-scroll-view n22-example-child-scroll-view-0">
    <n22-scroll-view
      ref="scrollView"
      @scroll="$_onScroll"
    >
...
<script>import {ScrollView, Toast} from 'al-mobile'
...
<style lang="stylus">
.n22-example-child-scroll-view-0
  height 400px
  background #FFF
  .scroll-view-item
    padding 30px 0
