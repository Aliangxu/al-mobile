<template>
  <div class="n22-activity-indicator-carousel">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      :viewBox="viewBox"
      :fill="color"
      :style="{width: `${viewWidth/2}px`, height: `${size}px`}"
      class="n22-activity-indicator-svg carouseling"
    >
      <n22-activity-indicator-carousel-circle
...
export default {
  name: 'n22-activity-indicator-carousel',
