<template>
  <div class="n22-activity-indicator-rolling-success">
...
export default {
  name: 'n22-activity-indicator-rolling-success',
...
.n22-activity-indicator-rolling-success
  ...
  .right
    ...
    line
      will-change auto
      &:first-child
        animation n22-activity-indicator-rolling-line0 .2s cubic-bezier(1.0, 0.5, 0.8, 1.0) forwards
      &:last-child
        opacity 0
        animation n22-activity-indicator-rolling-line1 .2s cubic-bezier(1.0, 0.5, 0.8, 1.0) .2s forwards

@keyframes n22-activity-indicator-rolling-line0
  from
    stroke-dashoffset 20
  to
    stroke-dashoffset 0
@keyframes n22-activity-indicator-rolling-line1
  from
    opacity 1
