<template>
  <div class="n22-drop-menu">
    <div class="n22-drop-menu-bar">
...
export default {
  ...
  methods: {
    ...
    $_setScroller() {
      const boxer = this.$el ? this.$el.querySelector('.n22-popup-box') : null
      /* istanbul ignore else */
      if (boxer && boxer.clientHeight >= this.$el.clientHeight) {
        this.scroller = '.n22-drop-menu-list'
      } else {
        return ''
      }
    },
...
.n22-drop-menu-list
  ...
  .n22-radio-item
    ...
    &.is-selected .n22-cell-item-title
      color color-primary
