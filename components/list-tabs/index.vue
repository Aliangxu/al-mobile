...
export default {
  ...
  computed: {
    ...
    dealLineStyle() {
      return () => {
        // 红线的位置
        console.log('%c ui.dealPxToVw(this.tabWidth)', 'color:green;', ui.dealPxToVw(this.tabWidth))
        ...
        return (this.lineStyle = {
          width: ui.dealPxToVw(barWidth) + 'vw',
          left: ui.dealPxToVw(parseInt(left)) + 'vw',
        })
      }
    },
  },
